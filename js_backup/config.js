...
const CONFIG = {
  ...
  // Player
  PLAYER: { SIZE: 18, BASE_SPEED: 180, BASE_HP: 12, INVINCIBILITY_TIME: 0.5, MAX_WEAPONS: 6, DODGE_BASE: 5 },
  ...
  WEAPON_DEFS: {
    knife:       { icon: '🗡️', name: 'Messer',    type: 'melee',  baseDamage: 3,  attackSpeed: 0.3,  range: 55,  arc: 1.2,  knockback: 2,  tier: 0, projectileColor: '#ddd', projectileSize: 3, projectileSpeed: 350, spread: 0.1 },
    sword:       { icon: '⚔️', name: 'Schwert',   type: 'melee',  baseDamage: 7,  attackSpeed: 0.5,  range: 75,  arc: 1.0,  knockback: 4,  tier: 1, projectileColor: '#aef', projectileSize: 3, projectileSpeed: 350, spread: 0.1 },
    club:        { icon: '🏏', name: 'Keule',     type: 'melee',  baseDamage: 12, attackSpeed: 0.8,  range: 65,  arc: 0.8,  knockback: 8,  tier: 1, projectileColor: '#fa4', projectileSize: 4, projectileSpeed: 300, spread: 0.15 },
    hammer:      { icon: '🔨', name: 'Hammer',    type: 'melee',  baseDamage: 18, attackSpeed: 1.0,  range: 70,  arc: 0.9,  knockback: 12, tier: 3, projectileColor: '#fa4', projectileSize: 5, projectileSpeed: 250, spread: 0.15 },
    pistol:      { icon: '🔫', name: 'Pistole',   type: 'ranged', baseDamage: 5,  attackSpeed: 0.35, range: 250, projectileSpeed: 350, pierce: 0, tier: 0, projectileColor: '#ff8', projectileSize: 3, spread: 0.05 },
    shotgun:     { icon: '💥', name: 'Schrotflinte', type: 'ranged', baseDamage: 8, attackSpeed: 0.7, range: 120, projectileSpeed: 250, pierce: 0, tier: 2, pellets: 3, spread: 0.4, projectileColor: '#fa4', projectileSize: 3 },
    smg:         { icon: '🔧', name: 'SMG',       type: 'ranged', baseDamage: 3,  attackSpeed: 0.12, range: 200, projectileSpeed: 400, pierce: 0, tier: 1, projectileColor: '#8ff', projectileSize: 2, spread: 0.08 },
    sniper:      { icon: '🎯', name: 'Sniper',    type: 'ranged', baseDamage: 20, attackSpeed: 1.2, range: 450, projectileSpeed: 600, pierce: 1, tier: 2, projectileColor: '#f88', projectileSize: 4, spread: 0.02 },
    shuriken:    { icon: '⭐', name: 'Shuriken',  type: 'ranged', baseDamage: 4,  attackSpeed: 0.15, range: 180, projectileSpeed: 300, pierce: 2, tier: 2, projectileColor: '#af4', projectileSize: 4, spinning: true, spread: 0.2 },
    crossbow:    { icon: '🏹', name: 'Armbrust',  type: 'ranged', baseDamage: 14, attackSpeed: 0.9, range: 300, projectileSpeed: 450, pierce: 1, tier: 2, projectileColor: '#faf', projectileSize: 3, spread: 0.05 },
  },
